...
class RegisterHandle(object):
    ...
    def send_user_email(self, email):
        if not self.register_p.get_email_element() is None:
            self.register_p.get_email_element().clear()
        self.register_p.get_email_element().send_keys(email)

    # 输入用户名
    def send_user_name(self, username):
        if not self.register_p.get_username_element() is None:
            self.register_p.get_username_element().clear()
        self.register_p.get_username_element().send_keys(username)

    # 输入密码
    def send_user_password(self, password):
        if not self.register_p.get_password_element() is None:
            self.register_p.get_password_element().clear()
    ...
    def send_user_code(self, file_name):
        ...
        if not self.register_p.get_email_element() is None:
            self.register_p.get_code_element().clear()
    ...
    def get_register_text(self):
        if self.register_p.get_button_element() is None:
            return
...
if __name__ == '__main__':
    ...
    # register_handle.send_user_email("jackie@126.com")
